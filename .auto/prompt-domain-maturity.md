...
When `domain_level3_capabilities` equals the six eligible targets and `remaining_domain_gates=0`, record one plateau result and stop. Do not run measurement-only iterations until an approved objective scope or metric changes.
