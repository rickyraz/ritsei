...
| `frontend.design-system`             | RITSEI-owned UI wrappers enforce approved Kobalte/Panda boundaries, semantic tokens, Product Pattern contracts, density/theme behavior, and no feature-local vendor imports.                                                                                                                                                                       |
